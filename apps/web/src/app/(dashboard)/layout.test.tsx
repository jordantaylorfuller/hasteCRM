...
describe('Dashboard Layout', () => {
  ...
  it('highlights active navigation item', () => {
    ...
    const activeLink = contactsLinks.find(link => {
      ...
      return linkElement?.className?.includes('bg-gray-100') && linkElement?.className?.includes('text-gray-900');
    });
  ...
  it('toggles mobile sidebar', async () => {
    ...
    const mobileSidebar = screen.getByTestId('icon-x').closest('nav')?.parentElement;
  ...
  it('displays correct page title in mobile header', () => {
    ...
    const mobileHeader = screen.getByTestId('icon-menu').parentElement?.parentElement;
