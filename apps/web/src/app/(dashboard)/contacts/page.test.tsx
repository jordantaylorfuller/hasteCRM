...
describe('Contacts Page', () => {
  ...
  it('renders page header correctly', () => {
    ...
    expect(screen.getByText('Manage your contacts and build meaningful relationships')).toBeInTheDocument();
  });
  ...
  it('shows error message', () => {
    ...
    expect(screen.getByText(`Error loading contacts: ${errorMessage}`)).toBeInTheDocument();
  });
