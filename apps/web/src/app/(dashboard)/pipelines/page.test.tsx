...
jest.mock('@/components/ui/tabs', () => ({
  ...
  TabsTrigger: ({ value: triggerValue, children, currentValue, onValueChange }: any) => (
...
describe('Pipelines Page', () => {
  ...
  it('switches between pipelines', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByTestId('pipeline-board')).toHaveTextContent('Pipeline: Sales Pipeline');
    });
  });
