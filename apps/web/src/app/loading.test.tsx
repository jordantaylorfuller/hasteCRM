...
describe('Loading Page', () => {
  ...
  it('should have centered layout', () => {
    ...
    expect(mainContainer).toHaveClass('min-h-screen', 'flex', 'items-center', 'justify-center', 'bg-gray-50');
  });
  ...
  it('should render animated spinner', () => {
    ...
    expect(spinner).toHaveClass('w-8', 'h-8', 'border-4', 'border-blue-600', 'border-t-transparent', 'rounded-full');
  });
