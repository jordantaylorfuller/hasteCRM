...
describe("Calendar", () => {
  ...
  it("applies custom className", () => {
    ...
    const { container } = render(
      <Calendar {...defaultProps} className={customClass} />,
    );
  ...
  it("applies custom classNames to specific parts", () => {
    ...
    const { container } = render(
      <Calendar {...defaultProps} classNames={customClassNames} />,
    );
  ...
  it("supports range selection mode", () => {
    ...
    render(<Calendar mode="range" selected={range} onSelect={onSelect} />);
  ...
  it("disables dates when disabled prop is provided", () => {
    ...
    render(<Calendar {...defaultProps} disabled={disabledFn} />);
  ...
  it("renders with multiple months", () => {
    render(<Calendar {...defaultProps} numberOfMonths={2} />);
  ...
  it("respects min and max date constraints", () => {
    ...
    render(<Calendar {...defaultProps} fromDate={minDate} toDate={maxDate} />);
  ...
  it("handles custom day rendering", () => {
    ...
    const { container } = render(
      <Calendar {...defaultProps} components={components} />,
    );
  ...
  it("supports different locales", () => {
    ...
    render(<Calendar {...defaultProps} locale={locale as any} />);
  ...
  it("handles footer content", () => {
    ...
    render(<Calendar {...defaultProps} footer={footer} />);
