...
const mockEmail: Email = {
  ...
  bodyHtml: "<p>This is the <strong>HTML body</strong> of the email.</p><p>Best regards,<br>John</p>",
...
describe("EmailViewer", () => {
  ...
  it("renders email content correctly", () => {
    ...
    // Recipients
    expect(screen.getByText("me@example.com, team@example.com")).toBeInTheDocument();
  ...
  it("handles star toggle", async () => {
    ...
    const starButton = screen.getAllByRole("button").find(
      (btn) => btn.querySelector(".lucide-star") !== null,
    );
  ...
  it("shows filled star for starred emails", () => {
    ...
    const starButton = screen.getAllByRole("button").find(
      (btn) => btn.querySelector(".fill-yellow-400") !== null,
    );
  ...
  it("handles archive action", async () => {
    ...
    const archiveButton = screen.getAllByRole("button").find(
      (btn) => btn.querySelector(".lucide-archive") !== null,
    );
  ...
  it("formats file sizes correctly", () => {
    const emailWithVariousAttachments: Email = {
      ...
      attachments: [
        ...
        { id: "4", gmailId: "g4", filename: "large.zip", mimeType: "application/zip", size: 1073741824 },
      ],
    };
  ...
  it("handles close button click", async () => {
    ...
    const closeButton = document.querySelector('button .lucide-x')?.parentElement as HTMLElement;
