          ...
          parts: [
            {
              mimeType: "text/plain",
              body: {
                data: Buffer.from("This is the plain text body").toString(
                  "base64",
                ),
              },
            },
            {
              mimeType: "text/html",
              body: {
                data: Buffer.from("<p>This is the HTML body</p>").toString(
                  "base64",
                ),
              },
            },
          ...
          parts: [
            {
              mimeType: "text/plain",
              body: {
                data: Buffer.from("Email with attachment").toString("base64"),
              },
            },
            {
        ...
        payload: {
          headers: [
            { name: "From", value: '"Last, First" <first.last@example.com>' },
            {
              name: "To",
              value:
                '"Smith, John" <john.smith@example.com>, "Doe, Jane" <jane.doe@example.com>',
            },
