...
describe('PipelinesResolver', () => {
  ...
  describe('pipelines query', () => {
    it('should return all pipelines', async () => {
      ...
      expect(mockPipelinesService.findAll).toHaveBeenCalledWith('workspace-123');
    });
  });
  ...
  describe('createPipeline mutation', () => {
    it('should create a pipeline', async () => {
      ...
      expect(mockPipelinesService.create).toHaveBeenCalledWith('workspace-123', createInput);
    });
  });
  ...
  describe('updatePipeline mutation', () => {
    it('should update a pipeline', async () => {
      ...
      expect(mockPipelinesService.update).toHaveBeenCalledWith('pipeline-1', updateInput);
    });
  });
  ...
  describe('reorderPipelines mutation', () => {
    it('should reorder pipelines', async () => {
      ...
      mockPipelinesService.reorderPipelines.mockResolvedValue(mockReorderedPipelines);
  ...
  describe('createStage mutation', () => {
    it('should create a stage', async () => {
      ...
      const result = await resolver.createStage('pipeline-1', 'New Stage', '#FF0000', 50);

      expect(result).toEqual(mockCreatedStage);
      expect(mockPipelinesService.createStage).toHaveBeenCalledWith('pipeline-1', {
        name: 'New Stage',
        color: '#FF0000',
        probability: 50,
      });
  ...
  describe('updateStage mutation', () => {
    it('should update a stage', async () => {
      ...
      const result = await resolver.updateStage('stage-1', 'Updated Stage', '#00FF00', 75);
  ...
  describe('reorderStages mutation', () => {
    it('should reorder stages', async () => {
      ...
      expect(mockPipelinesService.reorderStages).toHaveBeenCalledWith('pipeline-1', input.ids);
    });
  });
});
...
describe('DealsResolver', () => {
  ...
  describe('deals query', () => {
    ...
    it('should use default pagination', async () => {
      ...
      await resolver.deals(undefined, undefined, undefined, undefined, undefined, undefined, mockContext);
  ...
  describe('createDeal mutation', () => {
    it('should create a deal', async () => {
      ...
      expect(mockDealsService.create).toHaveBeenCalledWith('workspace-123', createInput);
    });
  });
  ...
  describe('updateDeal mutation', () => {
    it('should update a deal', async () => {
      ...
      expect(mockDealsService.update).toHaveBeenCalledWith('deal-1', updateInput);
    });
  });
  ...
  describe('bulkMoveDeal mutation', () => {
    it('should move multiple deals', async () => {
      ...
      const result = await resolver.bulkMoveDeal(dealIds, 'stage-2', mockContext);
  ...
  describe('bulkUpdateDealOwner mutation', () => {
    it('should update owner for multiple deals', async () => {
      ...
      const mockUpdatedDeals = dealIds.map(id => ({ id, ownerId: 'user-456' }));
      ...
      expect(mockDealsService.bulkUpdateOwner).toHaveBeenCalledWith(dealIds, 'user-456');
    });
  });
});